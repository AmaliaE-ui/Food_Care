...
public class ChooseRoleGuiController {
    ...
    private void handlePatientChoice(ActionEvent event) {
        NavigationManager.switchScene(event, "/ispw/food_care/Login/registrationPatient.fxml", "Registrazione");
    ...
    private void handleNutritionistChoice(ActionEvent event) {
        NavigationManager.switchScene(event, "/ispw/food_care/Login/registrationNutritionist.fxml", "Registrazione");
